 ...
 const [activeMenuItem, setActiveMenuItem] = useState(null);
  ...
  return (
    ...
    <div>
      <div>
        <Nav/>
      <div className='md:mx-20 md:mt-10' id="content">   
      <div className='flex gap-10 p-5'>
            <div className="hidden absolute sm:block sidebar w-64 md:ml-10 ">
      ...
      <Sidebar>
        <SidebarMenuItem
          ...
          active={activeMenuItem === 'General Information'}
        />
        <SidebarMenuItem
          label='About'
          href='#about'
        ...
        <SidebarMenuItem
          ...
          href='#work exp'
          onClick={() => handleMenuItemClick('Working Experience')}
          active={activeMenuItem === 'Working Experience'}
        />
        <SidebarMenuItem
          label='Skils'
          href='#skills'
          onClick={() => handleMenuItemClick('Skils')}
          active={activeMenuItem === 'Skils'}
        />
        <SidebarMenuItem
          label='Education'
          href='#education'
        ...
        <div className=' mb-2 mr-2'>
          ...
          <Fragment>
            ...
            <Accordion  open={open1 === 1} animate={customAnimation} className="font-body border border-[#F3F4F6FF] p-5 text-t2 md:text-t3 lg:text-t4 " id="gen%20info">
            ...
            <Accordion open={open3 === 3} animate={customAnimation} className="font-body  border border-[#F3F4F6FF] p-5 text-t2 md:text-t3 lg:text-t4" id="work%20exp" >
            ...
            <Accordion open={open4 === 4} animate={customAnimation} className="font-body border border-[#F3F4F6FF] p-5 text-t2 md:text-t3 lg:text-t4">
              <AccordionHeader id=" skills" onClick={() => handleOpen4(4)}>
                SKILLS
              </AccordionHeader>
              <AccordionBody>
           skill body
